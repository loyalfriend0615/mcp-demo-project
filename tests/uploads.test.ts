import fs from 'fs';
import type { ResponseLike } from 'mcp-demo-project/internal/to-file';
import { toFile } from 'mcp-demo-project/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('mcp-demo-project/core/uploads');
    await expect(
